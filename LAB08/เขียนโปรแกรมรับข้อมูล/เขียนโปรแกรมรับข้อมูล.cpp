...
static void inputStudent(Student& s1) {
	...
	cout << "myParent: ";
	cin >> s1.myParent1.name;

	cout << "relationship: ";
	cin >> s1.myParent1.relationship;

	cout << "Parentnumber: ";
	cin >> s1.myParent1.contact.mobile;
...
static void printStudent(const Student& s1) {
	...
	cout << "myParent :" << s1.myParent1.name << endl;
	cout << "relationship :" << s1.myParent1.relationship << endl;
	cout << "-------Parent contact-------- " << endl;
	cout << "Parentnumber: " << s1.myParent1.contact.mobile << endl;
	cout << "home number: " << s1.myContact.home << endl;
}
